...
echo [INFO] Starting Flask backend and Next.js frontend...
...
echo [NEXTJS] Frontend starting on http://localhost:3000
start "Next.js Frontend" /min cmd /c "cd /d %FRONTEND_DIR% && npm run dev"
